...
USERNAME = environ.get('USERNAME', "https://t.me/vampirexgirl") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001158261574'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+eGLbG384d8JkM2Nl')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Tg_filesx')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Noob_Marcus_Support') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
IS_VERIFY = is_enabled('IS_VERIFY', True)
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/how_to_download_movi/16")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/how_to_download_movi/16")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/how_to_download_movi/5")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "d122f174a129c5e2b458fa40e78f3bcb1b647ca9")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'modijiurl.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "1ebcbed21384dc0c14a391046a9e2c9afc88c2c9")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'modijiurl.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "73864ab32816f09a175150af803b888652d28dbd")
...
ADDGRP_PIC = environ.get("ADDGRP_PIC", "https://envs.sh/KZX.jpg https://envs.sh/KZy.jpg https://envs.sh/KZ6.jpg https://envs.sh/KZV.jpg https://envs.sh/KZx.jpg https://envs.sh/KZ-.jpg https://envs.sh/KLD.jpg").split()
#---------------------------------------------------------------
...
PING_INTERVAL = int(environ.get("PING_INTERVAL", "1200"))  # 20 minute
if 'DYNO' in environ:
    ON_HEROKU = True
else:
    ON_HEROKU = False
URL = environ.get("FQDN", "https://noob-marcus-moviebot2.koyeb.app/")
